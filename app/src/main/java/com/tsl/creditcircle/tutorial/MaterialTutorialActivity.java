package com.tsl.creditcircle.tutorial;
...
public abstract class MaterialTutorialActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(agency.tango.materialintroscreen.R.layout.activity_material_intro);

        overScrollLayout = (OverScrollViewPager) findViewById(agency.tango.materialintroscreen.R.id.view_pager_slides);
        viewPager = overScrollLayout.getOverScrollView();
        pageIndicator = (InkPageIndicator) findViewById(agency.tango.materialintroscreen.R.id.indicator);
        backButton = (ImageButton) findViewById(agency.tango.materialintroscreen.R.id.button_back);
        nextButton = (ImageButton) findViewById(agency.tango.materialintroscreen.R.id.button_next);
        skipButton = (ImageButton) findViewById(agency.tango.materialintroscreen.R.id.button_skip);
        messageButton = (Button) findViewById(agency.tango.materialintroscreen.R.id.button_message);
        coordinatorLayout = (CoordinatorLayout) findViewById(agency.tango.materialintroscreen.R.id.coordinator_layout_slide);
        navigationView = (LinearLayout) findViewById(agency.tango.materialintroscreen.R.id.navigation_view);
    ...
    public void showPermissionsNotGrantedError() {
        showError(getString(agency.tango.materialintroscreen.R.string.please_grant_permissions));
    }
    ...
    private void nextButtonBehaviour(final int position, final SlideFragment fragment) {
        boolean hasPermissionToGrant = fragment.hasNeededPermissionsToGrant();
        if (hasPermissionToGrant) {
            nextButton.setImageDrawable(ContextCompat.getDrawable(this, agency.tango.materialintroscreen.R.drawable.ic_next));
        } else if (adapter.isLastSlide(position)) {
            nextButton.setImageDrawable(ContextCompat.getDrawable(this, agency.tango.materialintroscreen.R.drawable.ic_finish));
